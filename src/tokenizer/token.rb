...
module TokenKind
  ...
  OP_ASSIGN            = 0x21
  OP_PLUS_ASSIGN       = 0x22
  OP_MINUS_ASSIGN      = 0x23
  OP_ASTERISK_ASSIGN   = 0x24
  OP_SLASH_ASSIGN      = 0x25
  OP_MODULUS_ASSIGN    = 0x26
  OP_LESS              = 0x27
  OP_GREATER           = 0x28
  OP_EQUAL             = 0x29
  OP_NOT_EQUAL         = 0x2A
  OP_LESS_EQUAL        = 0x2B
  OP_GREATER_EQUAL     = 0x2C
  OP_RETURN            = 0x2D
  OP_EXCLAMATION       = 0x2E
  OP_AT                = 0x2F
  OP_ASSIGN_ERROR      = 0x30

  OP_COMMA             = 0x31
  OP_COLON             = 0x32
  OP_DOUBLE_COLON      = 0x33
  OP_DOT               = 0x34
  OP_SINGLE_QUOTE      = 0x35
  OP_OPEN_PARENTHESIS  = 0x36
  OP_CLOSE_PARENTHESIS = 0x37
  OP_OPEN_BRACKETS     = 0x38
  OP_CLOSE_BRACKETS    = 0x39
  OP_OPEN_CURLYBRACES  = 0x3A
  OP_CLOSE_CURLYBRACES = 0x3B
end
